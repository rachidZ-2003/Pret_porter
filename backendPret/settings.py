"""
Django settings for backendPret project.
...
SECRET_KEY = 'django-insecure-n8f$z!7ggfa3p_e_5zok%xkgf=+hm-5cubdlnyr7sz4(u4a(am'
...
WSGI_APPLICATION = 'backendPret.wsgi.application'
